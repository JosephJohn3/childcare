 ...
 * AgentProcess.php
 * 
 * The AgentProcess class is meant to simplify the task of processing
 * agent submitted forms from the agent center, these deal with
...
class AgentProcess
{
   ...
   function procDeleteUser(){
      ...
      /* Delete user from database */
         ...
         $q = "DELETE FROM ".TBL_USERS." WHERE username = '$subuser' and parent_directory = '$session->username'";
         $database->query($q);
         header("Location: ".$session->referrer);
      }
   }
